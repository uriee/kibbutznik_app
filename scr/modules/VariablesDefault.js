...
class DefaultVariables {
    static async insert(variable_name, variable_type, variable_value) {
        ...
        const query = 'INSERT INTO DefaultVariables (variable_id, variable_name, variable_type, variable_default_value) VALUES (uuid(), ?, ?, ?)';
        const params = [ variable_name, variable_type, variable_value ];
    ...
    async PopulateByBase() {
        for (let item of this.base) {
            await this.insert(item.name, item.type, item.value);
        }
    }
}
